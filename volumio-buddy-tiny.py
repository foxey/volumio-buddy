...
from volumio_buddy import PushButton, RotaryEncoder, RGBLED, VolumioClient, Display, PipeWriter, Network, Battery, PUD_UP
...
# Display the menu modal
    ...
    rotary_encoder = RotaryEncoder(ROT_ENC_2B, ROT_ENC_2A, minimum_delay=0.1, pud=PUD_UP)
